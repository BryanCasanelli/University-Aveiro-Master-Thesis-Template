...
% Bibliography
\usepackage[backend=bibtex,sorting=none,style=ieee,url=false,sortcites=true,compress=true]{biblatex}
...
% Acronym index
\usepackage[acronym,automake,style=long]{glossaries-extra}
\makeglossaries
...
\colorlet{pantonecolor}{black}  % Change by the corresponding color
